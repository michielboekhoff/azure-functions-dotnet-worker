...
namespace Microsoft.Extensions.Hosting
{
    ...
    public static class WorkerHostBuilderExtensions
    {
        ...
        /// <summary>
        /// Configures the default set of Functions Worker services to the provided <see cref="IHostBuilder"/> for testing.
        /// </summary>
        /// <param name="builder"></param>
        /// <returns>the host builder</returns>
        public static IHostBuilder ConfigureFunctionsTestWorkerDefaults(this IHostBuilder builder) {
            return builder;
        }
